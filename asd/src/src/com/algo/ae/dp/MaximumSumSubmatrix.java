 ...
 * that returns the maximum sum that can be generated from a submatrix with dimensions
 * size * size.
 *
 ...
 * ]
 *
 * If size = 2, then 2x2 submatrices to consider are:
 * [2, 4]
 * [5, 6]
 * --------
 * [5, 6],
 * [-3, 2]
 *
 * The sum of elements in the first submatrix is 17, and the sum of the elements in the
 * second matrix is 10. In this example, your function should return 17.
 *
