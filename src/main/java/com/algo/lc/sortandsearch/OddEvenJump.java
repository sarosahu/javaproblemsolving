 ...
 * 975. Odd Even jump
 *
 * You are given an integer array arr. From some starting index, you can make a series
 * of jumps. The (1st, 3rd, 5th, ...) jumps in the series are called odd-numbered jumps,
